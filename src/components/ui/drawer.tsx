...
// Simple zero-dependency cn class helper replacing clsx/tailwind-merge
...
function Drawer({
  ...
  snapPoints,
  swipeDirection = "right", // Changed default to "right" to align with standard sidebar drawer
  ...props
...
function DrawerTitle({ className, ...props }: DrawerPrimitive.Title.Props) {
  return (
    <DrawerPrimitive.Title
      ...
      className={(state) => cn(
        "text-base font-medium text-white heading-font",
        typeof className === "function" ? className(state) : className
      )}
      {...props}
    />
...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={(state) => cn(
        "text-sm text-balance text-slate-400",
        typeof className === "function" ? className(state) : className
      )}
      {...props}
    />
